...
\usepackage[style=authoryear]{biblatex}  % in latex-custom-kjh/needs-biblatex       
...
\setmonofont[Mapping=tex-tex`t,Scale=0.8]{Pragmata} 
...
\chapterstyle{article-2}   % alternative styles defined in latex-custom-kjh/needs-memoir/      
\pagestyle{kjh} 
